...
Public Class frmrecivelist
    ...
    Private Sub frmorder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dtorder.Clear()
        Dim sta As String = "%"
        order.loadorder_dt(Format(CDate(dt1.Text), "MM/dd/yyyy"), Format(CDate(dt2.Text), "MM/dd/yyyy"), dtorder, "%", sta)
        ...
        For i As Integer = 0 To dtorder.Rows.Count - 1
            ...
            Dim tax As Integer = dtorder.Rows(i).Item(28)
            ...
            Else
                receive = True
            End If
            dgvshow.Rows.Add(orderno1, pay, ordername, buyfrom, tax, discount1, total, totalpay, notpay, saledate1, status, receive, note1, mainmoney, sup_id, supname)
        Next
        rdate.Checked = True
    ...
    Public Sub Ordercolumns()
        ...
        Dim tax As New DataGridViewTextBoxColumn
        ...
        With dgvshow
            ...
            .Columns(10).HeaderText = "ຍົກເລີກ"
            .Columns(11).HeaderText = "ຮັບ"
    ...
    Private Sub btnshow_Click(sender As Object, e As EventArgs) Handles btnshow.Click
        Try
            If rdate.Checked = True Then
                ...
                Ordercolumns()
                dtorder.Clear()
                order.loadorder_dt(Format(CDate(dt1.Text), "MM/dd/yyyy"), Format(CDate(dt2.Text), "MM/dd/yyyy"), dtorder, "%", "%")
                'order.loadorder(Format(CDate(dt1.Text), "MM/dd/yyyy"), Format(CDate(dt2.Text), "MM/dd/yyyy"), dgvshow)
                For i As Integer = 0 To dtorder.Rows.Count - 1
                    Dim orderno1 As String = dtorder.Rows(i).Item(0)
                    Dim pay As String = dtorder.Rows(i).Item(2)
            ...
            ElseIf rstatus.Checked = True Then
                ...
                dgvshow.Rows.Clear()
                Ordercolumns()
                order.viewstatus(cbstatus.SelectedItem.ToString, dtorder, "%")
                'order.loadorder(Format(CDate(dt1.Text), "MM/dd/yyyy"), Format(CDate(dt2.Text), "MM/dd/yyyy"), dgvshow)
                For i As Integer = 0 To dtorder.Rows.Count - 1
                    Dim orderno1 As String = dtorder.Rows(i).Item(0)
                    Dim pay As String = dtorder.Rows(i).Item(2)
