...
Public Class frmreportsaledetaillist2
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        Try
            ...
            Dim cry As New reportsaledetaillist2
    ...
    Private Sub TextBox1_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox1.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            dt.Clear()
            cn.connect()
            cm = New SqlCommand("select * from viewsale where  saleNO like N'%" & TextBox1.Text & "%' and pricetype like N'%" & frmmain.pricesend.Text & "%' order by saleNO asc", cn.conn)
            With da
                .SelectCommand = cm
                .Fill(dt)
            End With
