...
Public Class frmreportsaledetaillist1
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        Try
            ...
            cn.connect()
            If cbstatusapprove.SelectedIndex = 0 Then
                cm = New SqlCommand("select * from viewsale where saledate>='" & Format(CDate(date1.Text), "MM/dd/yyyy") & "' and saledate<='" & Format(CDate(date2.Text), "MM/dd/yyyy") & "' and  statusid='" & cancelnum & "' and pricetype like N'%" & frmmain.pricecash.Text & "%' order by saleNO asc", cn.conn)
            ElseIf cbstatusapprove.SelectedIndex = 1 Then
                cm = New SqlCommand("select * from viewsale where  saleNO in (select saleNO from tbsaleapprove where saleapprovedate>='" & Format(CDate(date1.Text), "MM/dd/yyyy") & "' and saleapprovedate<='" & Format(CDate(date2.Text), "MM/dd/yyyy") & "') and approve  like N'%" & statusname & "%' and statusid='" & cancelnum & "' and payname like N'%" & status & "%' and pricetype like N'%" & frmmain.pricecash.Text & "%' order by saleNO asc", cn.conn)
            ElseIf cbstatusapprove.SelectedIndex = 2 Then
                cm = New SqlCommand("select * from viewsale where saledate>='" & Format(CDate(date1.Text), "MM/dd/yyyy") & "' and saledate<='" & Format(CDate(date2.Text), "MM/dd/yyyy") & "'   and statusid='" & cancelnum & "' and payname like N'%" & status & "%' and pricetype like N'%" & frmmain.pricecash.Text & "%' order by saleNO asc", cn.conn)
            ElseIf cbstatusapprove.SelectedIndex = 3 Then
                cm = New SqlCommand("select * from viewsale where saledate>='" & Format(CDate(date1.Text), "MM/dd/yyyy") & "' and saledate<='" & Format(CDate(date2.Text), "MM/dd/yyyy") & "' and  statusid='" & cancelnum & "' and payname like N'%" & status & "%' and pricetype like N'%" & frmmain.pricecash.Text & "%' order by saleNO asc", cn.conn)
            ...
            Dim cry As New reportsaledetaillist1
    ...
    Private Sub TextBox1_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox1.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            dt.Clear()
            cn.connect()
            cm = New SqlCommand("select * from viewsale where  saleNO like N'%" & TextBox1.Text & "%' and pricetype like N'%" & frmmain.pricecash.Text & "%' order by saleNO asc", cn.conn)
            With da
                .SelectCommand = cm
                .Fill(dt)
            End With
