...
Public Class frmreportreceive
    ...
    Public formreportreceive As Boolean = False
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        Try
            ...
            dt.Clear()
            cn.connect()
            cm = New SqlCommand("select * from viewreceive where receive_date>='" & Format(CDate(date1.Text), "MM/dd/yyyy") & "' and receive_date<='" & Format(CDate(date2.Text), "MM/dd/yyyy") & "' and companyname like N'%" & customer & "%' and statusid<>4  order by receiveNO asc", cn.conn)
            With da
                .SelectCommand = cm
                .Fill(dt)
            End With
            Dim cry As New cryreceivebilldetail
