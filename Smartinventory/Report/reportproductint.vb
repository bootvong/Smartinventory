...
Public Class reportproductint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Smartinventory.reportproductint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreportproductint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportproductint = New reportproductint()
        rpt.Site = Me.Site
        Return rpt
    End Function
