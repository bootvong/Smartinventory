...
Public Class crysaledaily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Smartinventory.crysaledaily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrysaledaily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crysaledaily = New crysaledaily()
        rpt.Site = Me.Site
        Return rpt
    End Function
