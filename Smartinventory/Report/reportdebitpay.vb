...
Public Class reportdebitpay
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Smartinventory.reportdebitpay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreportdebitpay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportdebitpay = New reportdebitpay()
        rpt.Site = Me.Site
        Return rpt
    End Function
