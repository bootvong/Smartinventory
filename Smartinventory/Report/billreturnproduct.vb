...
Public Class billreturnproduct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Smartinventory.billreturnproduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedbillreturnproduct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As billreturnproduct = New billreturnproduct()
        rpt.Site = Me.Site
        Return rpt
    End Function
