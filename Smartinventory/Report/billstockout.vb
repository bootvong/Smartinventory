...
Public Class billstockout
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Smartinventory.billstockout.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedbillstockout
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As billstockout = New billstockout()
        rpt.Site = Me.Site
        Return rpt
    End Function
