...
Public Class crylogoheader
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Smartinventory.crylogoheader.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrylogoheader
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crylogoheader = New crylogoheader()
        rpt.Site = Me.Site
        Return rpt
    End Function
