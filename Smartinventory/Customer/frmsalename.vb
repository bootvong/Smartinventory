Public Class frmsalename
    Dim cate As New tbsalename
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        Try
            ...
            enablesave()
            txttype.Select()
            'Dim salename As frmshowsalename = CType(Application.OpenForms("frmshowsalename"), frmshowsalename)
    ...
    Private Sub frmsalename_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtid.Text = cate.runid
        cate.loadtbcategory(dgvshow)
        enablesave()
        txttype.Select()
    ...
    Private Sub frmsalename_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        'Try
        '    cate.loadtbcategory(frmshowsalename.dgvunit)
        'Catch ex As Exception
