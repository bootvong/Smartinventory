Public Class frmaccount
    ...
    Dim cate As New tbaccount
    Dim mon As New tbproduct
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        If txttype.Text = "" Then
            ...
            Return
        End If
        cate.save(txtid.Text, txttype.Text, cbmoney.SelectedValue)
        txttype.Clear()
    ...
    Private Sub btnupdate_Click(sender As Object, e As EventArgs) Handles btnupdate.Click
        cate.update(txtid.Text, txttype.Text, cbmoney.SelectedValue)
        txttype.ReadOnly = False
        txtid.Text = cate.runid
        cate.loadtbcategory(dgvshow)
        txttype.Clear()
